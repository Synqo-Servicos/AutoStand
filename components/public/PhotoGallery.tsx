...
export function PhotoGallery({ photos, alt }: { photos: VehiclePhoto[]; alt: string }) {
  ...
  if (!photos.length) {
    return (
      <div className="aspect-[4/3] bg-n100 rounded-2xl flex items-center justify-center text-n300">
  ...
  return (
    <>
      <div className="space-y-3">
        <div
          className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-n100 cursor-zoom-in"
