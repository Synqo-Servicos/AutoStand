  ...
  return (
    <div className="p-4 sm:p-8 max-w-6xl">
      ...
      <div className="bg-white rounded-xl border border-n200/70 overflow-hidden">
        <div className="bg-n50 border-b border-n100 px-4 py-3 grid grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-4">
        ...
        <div className="divide-y divide-n100">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="px-4 py-3 grid grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-4 items-center">
