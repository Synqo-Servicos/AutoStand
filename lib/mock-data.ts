...
// Pool de fotos do Unsplash. As chaves descrevem o "perfil visual" — não a marca.
// Cada veículo escolhe 2-3 fotos do mesmo perfil para a galeria parecer coerente.
const P = {
  // Compactos (HB20, Polo, Onix, Argo, Kwid, Pulse)
  hatch_red:        U("1571561944842-542037875b50"),
  hatch_teal:       U("1541899481282-d53bffe3c35d"),
  hatch_silver:     U("1485291571150-772bcfc10da5"),
  sedan_white:      U("1605559424843-9e4c228bf1c2"),
  sedan_dark:       U("1542362567-b07e54358753"),
  // SUVs / crossovers (Compass, T-Cross, Tracker, Creta, Kicks, HR-V, Taos)
  suv_white:        U("1533473359331-0135ef1b58bf"),
  suv_silver:       U("1606152421802-db97b9c7a11b"),
  suv_dark:         U("1605618826115-fb9e0c6e2af2"),
  // Sedans médios (Corolla, Civic, Sentra)
  sedan_silver:     U("1606664515524-ed2f786a0bd6"),
  sedan_black:      U("1556800572-1b8aedf82db0"),
  // Premium / esportivos (BMW, Audi, Mercedes, Volvo, Porsche, Mini)
  ...
  premium_white:    U("1492144534655-ae79c964c9d7"),
  lambo_yellow:     U("1494976388531-d1058494cdd8"),
  // Picapes (Hilux, Strada, Ranger, Amarok)
  pickup_silver:    U("1559416523-140ddc3d238c"),
  ...
  vehicles: [
    {
      ...
      status: "disponivel", photos: [P.suv_white, P.suv_silver, P.suv_dark],
    },
    {
      ...
      status: "reservado", photos: [P.sedan_black, P.sedan_dark, P.sedan_silver],
    },
    {
      ...
      status: "disponivel", photos: [P.sedan_silver, P.sedan_white, P.sedan_dark],
    },
    {
      ...
      status: "disponivel", photos: [P.suv_silver, P.suv_dark, P.suv_white],
    },
    {
    ...
    },
    {
      ...
      status: "disponivel", photos: [P.bmw_blue, P.sedan_black, P.sedan_dark],
    },
    {
      ...
      status: "disponivel", photos: [P.suv_dark, P.suv_silver, P.porsche_black],
    },
    {
      ...
      status: "disponivel", photos: [P.suv_dark, P.porsche_black, P.suv_silver],
    },
  ],
  transactions: [
  ...
  vehicles: [
    {
      ...
      status: "disponivel", photos: [P.hatch_red, P.sedan_white, P.sedan_silver],
    },
    {
      ...
      status: "disponivel", photos: [P.hatch_teal, P.bmw_blue, P.hatch_silver],
    },
    {
      ...
      status: "disponivel", photos: [P.sedan_white, P.hatch_silver, P.sedan_silver],
    },
    {
    ...
    },
    {
      ...
      status: "disponivel", photos: [P.hatch_silver, P.sedan_white, P.hatch_teal],
    },
    {
      ...
      status: "disponivel", photos: [P.hatch_red, P.hatch_silver, P.sedan_white],
    },
    {
    ...
    },
    {
      ...
      status: "disponivel", photos: [P.hatch_silver, P.hatch_red, P.hatch_teal],
    },
    {
      ...
      status: "disponivel", photos: [P.suv_white, P.suv_silver, P.hatch_silver],
    },
    {
      ...
      status: "vendido", photos: [P.suv_silver, P.suv_white, P.suv_dark],
    },
  ],
  transactions: [
  ...
  vehicles: [
    {
      ...
      status: "disponivel", photos: [P.porsche_black, P.suv_dark, P.mustang_black],
    },
    {
      ...
      status: "disponivel", photos: [P.suv_white, P.suv_silver, P.bmw_blue],
    },
    {
      ...
      status: "disponivel", photos: [P.sedan_dark, P.sedan_black, P.suv_silver],
    },
    {
      ...
      status: "reservado", photos: [P.suv_dark, P.porsche_black, P.mustang_black],
    },
    {
    ...
    },
    {
      ...
      status: "disponivel", photos: [P.suv_silver, P.suv_dark, P.porsche_black],
    },
    {
