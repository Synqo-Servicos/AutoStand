// AWS RDS global CA bundle — verificação TLS do Postgres (RDS).
// Fonte: https://truststore.pki.rds.amazonaws.com/global/global-bundle.pem
// (cert público; commitado para o cliente verificar a conexão com rejectUnauthorized)
